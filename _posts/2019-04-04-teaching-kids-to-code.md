...
When my son got home from school, I asked him if he'd seen them. He had them both. He saw them sitting on my desk, thought they looked interesting, and decided to read them. "Did you? I asked. "Yes," he replied. "Did you understand them?" He claimed he did, so I asked him to explain something to me. 

## What's a Lambda Expression?
Speaking of LINQ, one of the struggles I had with it at the time was the concept of lambda expressions. For some reason, it took me a long time to internalize the idea of passing functions into other functions. Lambda expressions complicated that by passing the entire function, unnamed, as a parameter. And calling them "lambda expressions" didn't help. 
...
Then he went a step further, and told me, "You could also sort it by something that isn't even part of the object itself." Then he provided this example for me.
...
Over the next few years, I continued to pay him for his time, whenever I had work I thought he could handle. When he was 15 years old, a former colleague of mine, who was the CEO of a small telecom firm, offered me a full-time job continuing to build on an application I had built for him over the prior year or so. 
...
He knew my son was a straight-A student in his High School, and was actively working on his Boy Scout Eagle Rank. Agreeing to give it a shot, he offered him $20/hour to maintain the application UI, an ASP.NET MVC 2 app tied to a SQL Server database.

His work was lauded by the CEO, who continued to tell the story to anyone who would listen. On one occasion, someone asked him what it took to create the application, the CEO smiled and said, "We built it all part-time with a credit card and an Eagle Scout!"

## Software Lead and DevOps Engineer
Over the next few years, while still in high school, my son continued working on the web app, branching out to the company's other applications. Eventually, he became the company's lead developer. 

He was responsible for creating a massive automated test suite, a multi-headed Jenkins DevOps system, updating the application's data layer, implementing Azure-hosted apps implemented in NodeJS and .NET Core. 

He's become quite adept in multiple software development disciplines, including mobile development. He has apps on Apple's, Google's, and Amazon's app stores. Recently, he deployed a Progressive Web App onto Google's Firebase, after the mobile version was rejected by both Apple and Google. 

## Software Engineering Major
Today my son is a Software Engineering major, working on his Bachelor's Degree. His 10+ years of paid software development experience helped him land a paid internship at a financial services company. When he leaves the university in a year or so, he'll do so with no student loan debt, and a comfortable amount of savings with which to start his adult life. I'm sure he'll have no trouble finding a full-time job. And all started with a visual design tool, some spare time, and a little curiosity. 

## Is This Repeatable?
My goal in writing this post was to try to identify specific things that I did, which might be able to replicated with other kids in the future. My other two children have thus far shown no interest in following in their brother's footsteps. That's fine, as I don't want to push them. But what about other youth in my sphere of influence who do want to learn? What would it take to help them along, the way I did with my son?

Some things that stand out to me, which may be applicable in the future:
...
- Give them a chance. It's easier to learn new things when you have a project to work on. If my CEO colleague hadn't given my son a chance, his interest might have waned and fizzled out while he was still in high school. 
