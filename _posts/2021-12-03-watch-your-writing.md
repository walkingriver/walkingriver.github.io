---
layout: post
title: Watch Your Writing - Tips to Improve Your Written Communications (Revised Dec 2021)
date: '2021-12-03'
...
canonical_url: https://walkingriver.com/watch-your-writing/
published: true
---
...
### October 2020 Update!
It was brought to my attention by [Team 33 Productions on Twitter](https://twitter.com/33ProductionsSP){:target="_blank"} that I am mistaken about this. Evidently irregardless is a word, as [reported by NPR](https://www.npr.org/2020/07/07/887649010/regardless-of-what-you-think-irregardless-is-a-word){:target="_blank"}. 
...
## It's/Its
This error is one I probably see more than any other. The confusion is that adding apostrophe-s to most words turns them into a possessive form. This is an exception to that rule. The word `it's` is a contraction, meaning `it is`. The correct possessive form is `its`, without the apostrophe.
...
## Then/Than
I think this one can be confusing because we no longer use `then` in most programming languages for conditionals. Shell script and BASIC programmers probably do not make this mistake.

`Then` follows `if`. `Than` is used to compare two things. 

Examples
- ❌ I like TypeScript better then JavaScript
- ✅ I like TypeScript better than JavaScript
...
## Your/Yours/You're
`Your` and `yours` are another example of possessive words that do not use an apostrophe. Its incorrect use almost always comes in the form of someone using `your` when they mean `you're`, or "you are." Every now and then, I see `your's`, which as far as I know, is never proper English.
...
# Contractions
Some two-word phrases are commonly abbreviated into contractions (can't, shouldn't, we're, they'll, etc.). Most of us who are not [Lt. Commander Data](https://memory-alpha.fandom.com/wiki/Verbal_contraction){:target="_blank"} use them almost unconsciously. 
